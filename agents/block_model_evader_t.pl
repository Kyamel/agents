% ============================================================
% LADRAO: block_model_evader_t
%
% Ladrao que combina ambiguidade de tesouro com evasao de bloqueios.
% Mantem >=2 tesouros prontos para cegar o preditor do roubo final, e
% coleta so os itens necessarios rumo ao alvo. Sobre isso adiciona um
% modelo AGNOSTICO de bloqueio (nao tenta adivinhar o adversario): preve
% a uniao das celulas que varias politicas trancariam — o passo goloso, a
% fila de vizinhos do ultimo roubo (1/turno) e a cidade do ultimo roubo —
% e rerroteia o passo de forma SOFT: desvia so se ha caminho limpo ao
% mesmo destino dentro de um teto de custo; senao segue o minimo e aceita
% o risco (nunca recusa objetivo). Se a celula atual for trancar neste
% turno, sai dela antes. Forte contra a familia de bloqueadores em mapas
% grandes; em mapas muito apertados a coleta de baits pode forca-lo a
% cidades trancadas.
% ============================================================

:- module(block_model_evader_t, [
    ladrao_preload/7,
    ladrao_action/3
]).
