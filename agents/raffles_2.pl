...
escolher_tesouro_e_reservas(Tesouro, Reservados) :-
    ...
    escolher_duas_reservas(CandidatosReserva, Reservados),
    !.
...
escolher_tesouro_e_reservas(Tesouro, Reservados) :-
    ...
    findall(T-Cands,
            ...
            Melhores0),
    random_member(Tesouro-CandidatosReserva, Melhores0),
    escolher_ate_duas_reservas(CandidatosReserva, Reservados).
...
% Prefere reservar folhas ou itens pouco conectados, pois deixar um
% requisito intermediario de fora poderia bloquear muitos outros.
escolher_duas_reservas(Candidatos, Reservados) :-
    pontuar_reservas(Candidatos, Pares),
    keysort(Pares, Ordenados),
    pares_para_itens(Ordenados, OrdenadosItens),
    primeiros_n(2, OrdenadosItens, Reservados).

escolher_ate_duas_reservas(Candidatos, Reservados) :-
    pontuar_reservas(Candidatos, Pares),
    keysort(Pares, Ordenados),
    pares_para_itens(Ordenados, OrdenadosItens),
    primeiros_n(2, OrdenadosItens, Reservados).
